        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{route('admins.index')}}">Home <span class="sr-only">({{auth('admin')->user()->name}})</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admins.logout')}}">Logout</a>
                </li>
                @else
                <li class="nav-item active">
                    <a class="nav-link" href="{{route('admins.create')}}">Register <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('admins.loginform')}}">Login</a>
                </li>
                @endif
                </form>
            </div>
